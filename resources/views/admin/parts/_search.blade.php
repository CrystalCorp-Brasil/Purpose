                                ...
                                <div class="card-body">
                                    <form action="{{ route($searchBar) }}" method="GET">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <span class="input-group-text p-0 m-0" id="basic-addon2"><button class="btn line-height-1" type="submit"><i class="search-icon i-Magnifi-Glass1"></i> Pesquisar</button></span>
                                        </div>
                                    </form>
                                </div>
                            </div>
