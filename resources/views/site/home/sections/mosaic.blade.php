                    ...
                    <div class="row py-8 min-vh-100 align-items-center">
                        <div class="col-md-auto px-md-4 ps-md-8">
                            ...
                            <div class="mt-3 mt-sm-5">
                                <a class="btn btn-gcc1 btn-sm my-2 me-2" href="" data-offset="60" data-zanim-xs='{"delay":1.3}'>Episódios &xrarr;</a>
                                <a class="btn btn-gcc1 btn-sm my-2" href="" data-zanim-xs='{"delay":1.3}'>Tutoriais &xrarr;</a>
                            </div>
                        </div>
                    </div>
                </div>
