...
@endsection
@section('PageTitle')Termos e Condições de Uso do Site @endsection
@section('content')
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title">
                                <h2 class="wow fadeInUp text-justify text-uppercase" data-wow-delay=".2s">Termos de Uso</h2>
                                ...
                                <p class="wow fadeInUp text-justify" data-wow-delay=".8s">Este documento, e todo o conteúdo do site é oferecido por <span class="text-info">CRYSTALCORP BRASIL</span>, neste termo representado apenas por <span class="text-info">CORPORAÇÃO</span>, que regulamenta todos os direitos e obrigações com todos que acessam o site, denominado neste termo como <span class="text-light">VISITANTE</span>, reguardado todos os direitos previstos na legislação, trazem as cláusulas abaixo como requisito para acesso e visita do mesmo, situado no endereço <a href="{{ route('home') }}" class="text-decoration-none">{{ route('home') }}</a>.</p>
                    ...
                    <div class="accordion bg-dark" id="accordionExample">
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <p class="text-justify">Este documento, chamado “Termos de Uso”, aplicáveis a todos os <span class="text-light">VISITANTES</span> do site, foi desenvolvido por Diego Castro Advogado – OAB/PI 15.613, modificado com permissão para este site.</p>
                                    <p class="text-justify">Este termo especifica e exige que todo <span class="text-light">VISITANTES</span> ao acessar o site da <span class="text-info">CORPORAÇÃO</span>, leia e compreenda todas as cláusulas do mesmo, visto que ele estabelece entre a <span class="text-info">CORPORAÇÃO</span> e o <span class="text-light">VISITANTE</span> direitos e obrigações entre ambas as partes, aceitos expressamente pelo <span class="text-light">VISITANTE</span> a permanecer navegando no site da <span class="text-info">CORPORAÇÃO</span>.</p>
                                    <p class="text-justify">Ao continuar acessando o site, o <span class="text-light">VISITANTE</span> expressa que aceita e entende todas as cláusulas, assim como concorda integralmente com cada uma delas, sendo este aceite imprescindível para a permanência na mesma. Caso o <span class="text-light">VISITANTE</span> discorde de alguma cláusula ou termo deste contrato, o mesmo deve imediatamente interromper sua navegação de todas as formas e meios.</p>
                                    <p class="text-justify">Este termo pode e irá ser atualizado periodicamente pela <span class="text-info">CORPORAÇÃO</span>, que se resguarda no direito de alteração, sem qualquer tipo de aviso prévio e comunicação. É importante que o <span class="text-light">VISITANTE</span> confira sempre se houve movimentação e qual foi a última atualização do mesmo no começo da página.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    ...
                                    <p class="text-justify"><span class="text-light">VISITANTE</span>: Todo e qualquer usuário do site, de qualquer forma e meio, que acesse através de computador, notebook, tablet, celular ou quaisquer outros meios, o website ou plataforma da <span class="text-info">CORPORAÇÃO</span>.</p>
                                    ...
                                    <p class="text-justify">COOKIES: Pequenos arquivos de textos gerados automaticamente pelo site e transmitido para o navegador do <span class="text-light">VISITANTE</span>, que servem para melhorar a usabilidade do <span class="text-light">VISITANTE</span>.</p>
                                    <p class="text-justify">LOGIN: Dados de acesso do <span class="text-light">VISITANTE</span> ao realizar o cadastro junto a <span class="text-info">CORPORAÇÃO</span>, dividido entre usuário e senha, que dá acesso a funções restritas do site.</p>
                                    ...
                                    <p class="text-justify">Em caso de dúvidas sobre qualquer palavra utilizada neste termo, o <span class="text-light">VISITANTE</span> deverá entrar em contato com a <span class="text-info">CORPORAÇÃO</span> através dos canais de comunicação encontradas no site.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    ...
                                    <p class="text-justify">Caso seja necessário realizar um cadastro junto a plataforma, onde o <span class="text-light">VISITANTE</span> deverá preencher um formulário com seus dados e informações, para ter acesso a alguma parte restrita, ou realizar alguma compra.</p>
                                    <p class="text-justify">Todos os dados estão protegidos conforme a Lei Geral de Proteção de Dados, e ao realizar o cadastro junto ao site, o <span class="text-light">VISITANTE</span> concorda integralmente com a coleta de dados conforme a Lei e com a Política de Privacidade da <span class="text-info">CORPORAÇÃO</span>.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <p class="text-justify">O <span class="text-light">VISITANTE</span> poderá acessar todo o conteúdo do website, como artigos, vídeos, imagens, produtos e serviços, não significando nenhum tipo de cessão de direito ou permissão de uso, ou de cópia dos mesmo.</p>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <p class="text-justify">O <span class="text-light">VISITANTE</span> ao utilizar o website da <span class="text-info">CORPORAÇÃO</span>, concorda integralmente em:</p>
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseSeven" class="accordion-collapse collapse" aria-labelledby="headingSeven" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    ...
                                    <p class="text-justify">Essas publicidades não significam nenhuma forma de endosso ou responsabilidade pelos mesmos, ficando o <span class="text-light">VISITANTE</span> responsável pelas compras, visitas, acessos ou quaisquer ações referentes as estas Empresas.</p>
                                    <p class="text-justify">Todas as propagandas no site ou plataforma serão claramente destacadas como publicidade, como forma de disclaimer da <span class="text-info">CORPORAÇÃO</span> e de conhecimento do <span class="text-light">VISITANTE</span>.</p>
                                    ...
                                    <p class="text-justify">Estes anúncios podem ser selecionados pela <span class="text-info">CORPORAÇÃO</span> de publicidade automaticamente, conforme as visitas recentes do <span class="text-light">VISITANTE</span>, assim como baseado no seu histórico de busca, conforme as políticas de acesso da plataforma.</p>
                                </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                            ...
                            <div id="collapseEight" class="accordion-collapse collapse" aria-labelledby="headingEight" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    ...
                                    <p class="text-justify">Em caso que ocorra eventuais conflitos judiciais entre o <span class="text-light">VISITANTE</span> e a <span class="text-info">CORPORAÇÃO</span>, o foro elegido para a devida ação será o da comarca da <span class="text-info">CORPORAÇÃO</span>, mesmo que haja outro mais privilegiado.</p>
